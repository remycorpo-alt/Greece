...
const MAPS = {
  ...
  parosHotel: 'https://maps.google.com/?q=Andronis+Minois+Hotel+Naoussa+Paros',
  parosTennis: 'https://maps.google.com/?q=tennis+club+Paros',
  parosSpa: 'https://maps.google.com/?q=spa+Naoussa+Paros',
  parosScuba: 'https://maps.google.com/?q=scuba+diving+Naoussa+Paros',
  parosWindsurf: 'https://maps.google.com/?q=windsurf+school+Paros+Naoussa',
...
const DAYS = [
  ...
  },
  {
    ...
    sub: 'Water sports · beach · spa before sailing',
    img: IMG.mykonos,
    dirUrl: 'https://www.google.com/maps/dir/Naoussa+Paros/Kolymbithres+Beach+Paros/Parikia+Port+Paros/Mykonos+New+Port',
    items: [
      { time: '08:00', icon: Coffee, label: 'Breakfast at the hotel', detail: 'Slow island morning at the Andronis Minois before heading out.', tag: 'Food', mapUrl: MAPS.parosHotel, photo: PHOTOS.hotel, place: 'Andronis Minois, Naoussa' },
      { time: '09:30', icon: Anchor, label: 'Option A · Scuba diving', detail: 'Guided dive from Naoussa — clear Aegean water with good visibility. Book with a local dive centre the evening before.', tag: 'Swim', mapUrl: MAPS.parosScuba, photo: PHOTOS.vouliagmeni, place: 'Naoussa dive centre' },
      { time: '09:30', icon: Wind, label: 'Option B · Windsurf session', detail: "Paros is one of the Aegean's top windsurf spots. Morning session with a local school — all levels welcome.", tag: 'Swim', mapUrl: MAPS.parosWindsurf, photo: PHOTOS.riviera, place: 'Naoussa windsurf school' },
      { time: '12:30', icon: Waves, label: 'Kolymbithres Beach swim', detail: 'Iconic granite-sculpted cove — a final Cycladic swim before the afternoon wind-down.', tag: 'Swim', mapUrl: MAPS.kolymbithres, photo: PHOTOS.vouliagmeni, place: 'Kolymbithres Beach' },
      { time: '15:00', icon: Heart, label: 'Spa & recovery', detail: 'Massage session at the hotel or a Naoussa spa to decompress before travel.', tag: 'Optional', mapUrl: MAPS.parosSpa, photo: PHOTOS.garden, place: 'Naoussa spa' },
